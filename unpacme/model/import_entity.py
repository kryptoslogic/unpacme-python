...
def lazy_import():
    ...
    globals()['ImportEntityAllOf'] = ImportEntityAllOf


class ImportEntity(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'library': (str,),  # noqa: E501
            'functions': ([Function],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, library, functions, *args, **kwargs):  # noqa: E501
        """ImportEntity - a model defined in OpenAPI
