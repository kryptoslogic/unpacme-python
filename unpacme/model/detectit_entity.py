...
def lazy_import():
    ...
    globals()['DetectitEntityAllOf'] = DetectitEntityAllOf


class DetectitEntity(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, options, string, type, version, *args, **kwargs):  # noqa: E501
        """DetectitEntity - a model defined in OpenAPI
