...
from unpacme import rest
from unpacme.configuration import Configuration
from unpacme.exceptions import ApiTypeError, ApiValueError, ApiException
from unpacme.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FeedApi()
        api_instance.get_private_feed  # this is an instance of the class Endpoint
        api_instance.get_private_feed()  # this invokes api_instance.get_private_feed.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_private_feed.callable or self.callable in this class
